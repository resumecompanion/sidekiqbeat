...
`${GOPATH}/src/github.com/resumecompanion/sidekiqbeat`
...
```
git remote set-url origin https://github.com/resumecompanion/sidekiqbeat
...
in the same directory with the name sidekiqbeat.
...
```
./sidekiqbeat -c sidekiqbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/resumecompanion/sidekiqbeat
git clone https://github.com/resumecompanion/sidekiqbeat ${GOPATH}/src/github.com/resumecompanion/sidekiqbeat
```
